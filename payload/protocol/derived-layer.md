...
Knowledge facet trees. Browse it through retrieval rather than a generated
file: `ask.js --fields` lists the Subjects a selection carries, and
`ask.js --count-by subject --under S-NNNNNN` counts records under each child
of a Subject. A `subjects/derived/` directory left by an earlier version is
disposable and no longer generated; delete it.
