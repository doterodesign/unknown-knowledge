...
Short, and dense. Every section names a different governed thing and introduces
different vocabulary — the opposite of the weekly status report, which is long
and says one thing.
